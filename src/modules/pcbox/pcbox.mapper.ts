...
export class PcboxMapper {
  /** DTO → persistable entity. Every field is copied as-is: by the time this runs, PcboxService has already confirmed status/ticket-hub-api/YAML are all valid, so nothing here is derived or defaulted. */
